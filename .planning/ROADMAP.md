...
Plans:
- [x] 04-01: Desenvolvimento da rota de injeção dinâmica de dados e estilos no template HTML.
- [x] 04-02: Integração com Puppeteer para renderizar a página em PDF e retornar o arquivo para download.
